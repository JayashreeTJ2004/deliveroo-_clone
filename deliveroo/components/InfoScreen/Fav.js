...
class Fav extends Component{ 
  render(){ 
    return(
 <View style={{marginStart:5,borderColor:"#e1edec",borderRadius:5,borderWidth:0.5,height:290,width:300,shadowColor:"black",shadowOffset:{width:0,height:8},shadowOpacity:0.16,shadowRadius:16,marginTop:7}}>
           <View style={{flex:2}}>
